...
T = [
    ...
    ('<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/">Privacy</a><a href="applicant-privacy/">Applicant Privacy</a><a href="terms/">Terms</a></nav>',
     '<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/">隐私政策</a><a href="applicant-privacy/">候选人隐私声明</a><a href="terms/">使用条款</a></nav>',
     '<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/">Confidentialité</a><a href="applicant-privacy/">Confidentialité des candidats</a><a href="terms/">Conditions d’utilisation</a></nav>',
     '<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/">Datenschutz</a><a href="applicant-privacy/">Datenschutz für Bewerbende</a><a href="terms/">Nutzungsbedingungen</a></nav>'),
