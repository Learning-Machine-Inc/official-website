...
T = [
    ...
    ('<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learning-machine.ai">Contact</a></nav>',
     '<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learning-machine.ai">联系我们</a></nav>',
     '<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learning-machine.ai">Contact</a></nav>',
     '<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learning-machine.ai">Kontakt</a></nav>'),
    # hero
    ...
    ('light-btn-blue" href="mailto:official@learning-machine.ai">Join us</a>',
     'light-btn-blue" href="mailto:official@learning-machine.ai">加入我们</a>',
     'light-btn-blue" href="mailto:official@learning-machine.ai">Nous rejoindre</a>',
     'light-btn-blue" href="mailto:official@learning-machine.ai">Komm ins Team</a>'),
    ...
    ('<h2>Join us</h2><p>We\'re building the future of AI, and we\'re hiring across research, engineering, and product. Come build it with us.</p><p class="join-privacy-note">Before applying, please review our <a href="applicant-privacy/">Applicant Privacy Notice</a>.</p><div class="join-actions"><a class="button button-dark" href="careers/">See open roles</a><a class="button button-blue" href="mailto:careers@learning-machine.ai">Get in touch</a></div>',
     '<h2>加入我们</h2><p>我们正在构建 AI 的未来，来和我们一起创造。</p><p class="join-privacy-note">投递前，请阅读我们的<a href="applicant-privacy/?lang=zh-CN">候选人隐私声明</a>。</p><div class="join-actions"><a class="button button-dark" href="careers/">查看开放岗位</a><a class="button button-blue" href="mailto:careers@learning-machine.ai">联系我们</a></div>',
    ...
    ('<p>Explore</p><a href="#approach">Approach</a><a href="careers/">Careers</a><a href="mailto:official@learning-machine.ai">Contact</a>',
     '<p>探索</p><a href="#approach">我们的方法</a><a href="careers/">招聘</a><a href="mailto:official@learning-machine.ai">联系我们</a>',
     '<p>Explorer</p><a href="#approach">Approche</a><a href="careers/">Carrières</a><a href="mailto:official@learning-machine.ai">Contact</a>',
     '<p>Entdecken</p><a href="#approach">Ansatz</a><a href="careers/">Karriere</a><a href="mailto:official@learning-machine.ai">Kontakt</a>'),
