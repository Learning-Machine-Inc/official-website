...
T = [
    ...
    ('<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learningmachine.ai">Contact</a></nav>',
     '<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learningmachine.ai">联系我们</a></nav>',
     '<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learningmachine.ai">Contact</a></nav>',
     '<nav class="light-nav" aria-label="Primary navigation"><a class="light-nav-contact" href="mailto:official@learningmachine.ai">Kontakt</a></nav>'),
    # hero
    ...
    ('>See our approach <img src="assets/figma-107/',
     '>了解我们 <img src="assets/figma-107/',
     '>Découvrir notre approche <img src="assets/figma-107/',
     '>Unser Ansatz <img src="assets/figma-107/'),
    ('light-btn-blue" href="mailto:official@learningmachine.ai">Join us</a>',
     'light-btn-blue" href="mailto:official@learningmachine.ai">加入我们</a>',
     'light-btn-blue" href="mailto:official@learningmachine.ai">Nous rejoindre</a>',
     'light-btn-blue" href="mailto:official@learningmachine.ai">Komm ins Team</a>'),
    ...
    ('<p>Explore</p><a href="#approach">Approach</a><a href="careers/">Careers</a><a href="mailto:official@learningmachine.ai">Contact</a>',
     '<p>探索</p><a href="#approach">我们的方法</a><a href="careers/">招聘</a><a href="mailto:official@learningmachine.ai">联系我们</a>',
     '<p>Explorer</p><a href="#approach">Approche</a><a href="careers/">Carrières</a><a href="mailto:official@learningmachine.ai">Contact</a>',
     '<p>Entdecken</p><a href="#approach">Ansatz</a><a href="careers/">Karriere</a><a href="mailto:official@learningmachine.ai">Kontakt</a>'),
    ('<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/">Privacy</a><a href="applicant-privacy/">Applicant Privacy</a><a href="terms/">Terms</a></nav>',
     '<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/?lang=zh-CN">隐私政策</a><a href="applicant-privacy/?lang=zh-CN">候选人隐私声明</a><a href="terms/?lang=zh-CN">使用条款</a></nav>',
     '<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/?lang=fr">Confidentialité</a><a href="applicant-privacy/?lang=fr">Confidentialité des candidats</a><a href="terms/?lang=fr">Conditions d’utilisation</a></nav>',
     '<nav class="footer-legal-links" aria-label="Legal"><a href="privacy/?lang=de">Datenschutz</a><a href="applicant-privacy/?lang=de">Datenschutz für Bewerbende</a><a href="terms/?lang=de">Nutzungsbedingungen</a></nav>'),
